			...
			<div className="container">
				<div className="roww resumo_fn_contact">
					...
					<div className="resumo_fn_main_title">
						...
						<p className="desc">
							If you have any suggestion, project or even
							you want to say “hello”, please fill out the
								...
								<div className="item half">
									...
									>
										<input
											...
											type="text"
										/>
										<span className="moving_placeholder">
											Name *
										</span>
									</div>
								</div>
					...
					<div className="resumo_fn_contact_info">
						...
						<p>
							<a
								className="fn__link"
								href="mailto:jashuadesigns@gmail.com"
							>
